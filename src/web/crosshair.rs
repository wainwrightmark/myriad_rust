...
fn crosshair(properties: &CrossHairProperties) -> Html {
    ...
    html!(
        ...
        <line key="line1" x1={(-HALF_CROSSHAIR_LENGTH).to_string()} x2={HALF_CROSSHAIR_LENGTH.to_string()} y1={0.0.to_string()} y2={0.0.to_string()}  class={line_classes.clone()} style={format!("transform: translate({}px, {}px) rotate({}deg) scaleX({scale});", l1x, l1y, l1rot )} />
        <line key="line2" x1={(-HALF_CROSSHAIR_LENGTH).to_string()} x2={HALF_CROSSHAIR_LENGTH.to_string()} y1={0.0.to_string()} y2={0.0.to_string()}  class={line_classes.clone()} style={format!("transform: translate({}px, {}px) rotate({}deg) scaleX({scale});", l2x, l2y, l2rot )}/>

        <line key="line3" x1={(-HALF_CROSSHAIR_LENGTH).to_string()} x2={HALF_CROSSHAIR_LENGTH.to_string()} y1={0.0.to_string()} y2={0.0.to_string()}  class={line_classes.clone()} style={format!("transform: translate({}px, {}px) rotate({}deg) scaleX({scale});", l3x, l3y, l3rot )} />
